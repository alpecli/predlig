...
sample = CDConstructor("microsoft_training.txt", 1000, (0.5, 0.5), "future_link_prediction", "microsoft_test.txt")
sample.set_classification_dataset('microsoft_final_version_attributes', 'microsoft_final_version')
